...
function About() {
  ...
  useEffect(
    () => {
        ...
        tl.from('#one',{opacity:0, duration:.8})
        tl.from('#two',{opacity:0, duration:.8})
        tl.from('#three',{opacity:0, duration:.8})
        tl.from('#four',{opacity:0, duration:.8})
        tl.from('#five',{opacity:0, duration:.8})
        tl.from('#six',{opacity:0, duration:.8})
        tl.from('#seven',{opacity:0, duration:.8})
        tl.from('#eight',{opacity:0, duration:.8})
        tl.from('#nine',{opacity:0, duration:.8})
        ...
        <div id="home" className=' h col'>
            <div id="about">
              ...
              <div className='row' id="aboutContent">
                <div className=" row col-12 col-sm-12 col-lg-6 col-xl-6 col-xxl-6" id="aboutText">
                  <div className='col-12' id='aboutMe'>
                   ...
                   Hello, my name is Elyon Omidiora and I am a self taught Front-End Developer. I am someone who has genuine interest in designing and bringing designs to life through code or any possible means. I socialize easily and I'm very fun to have around. I am hard-working in the sense that I do not procrastinate and I do my very best to get the job done before or on the due date. I am quite easy to communicate with, I learn pretty fast and I like to think I am a loveable person.
                    ...
                    <div id="resume">
                    <a href='https://drive.google.com/file/d/1I4JTv3ceR1izzvd3AjeSblAwBpEh7w7v/view'>
                    My Resume
                    </a>
                    </div>
                  </div>
                </div>
                <div className="col-12 col-sm-12 col-lg-6 col-xl-6 col-xxl-6" id="aboutImage">
                  <div id="imageHolder">
                    </div> 
                </div>
              </div>
